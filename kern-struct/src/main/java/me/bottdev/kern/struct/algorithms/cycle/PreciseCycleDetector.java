...
public class PreciseCycleDetector<N, K extends Comparable<K>> implements CycleDetector<N> {

    public static <N extends Comparable<N>> PreciseCycleDetector<N, N> identityNormalizer() {
        return new PreciseCycleDetector<N, N>(Function.identity());
    }

    private final Function<N, K> normalizer;

    public PreciseCycleDetector(Function<N, K> normalizer) {
