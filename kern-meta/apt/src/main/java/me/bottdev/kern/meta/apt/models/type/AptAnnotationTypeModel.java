...
public record AptAnnotationTypeModel(TypeModelSkeleton skeleton) implements AnnotationTypeModel {

    public static AptAnnotationTypeModel of(TypeElement type) {
        return new AptAnnotationTypeModel(TypeModelSkeleton.read(type));
    }
    ...
    @Override public List<AnnotationElementModel> elements() { return List.of(); } // TODO
}